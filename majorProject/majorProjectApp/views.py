...
def result(request):
    ...
    fO = open(r"C:\Users\Public\Documents\eightsem\majorProject\majorProjectApp\symptom.json")
    l1=json.load(fO)
    #convert into python list 


    #below code import json array file for disease
    fO1 = open(r"C:\Users\Public\Documents\eightsem\majorProject\majorProjectApp\disease.json")
